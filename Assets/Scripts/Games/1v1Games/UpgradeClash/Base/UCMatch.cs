...
namespace UpgradeClash
{
    ...
    {
        // Rules
        public const int StartHealth = 300;
        ...
        {
            Debug.Log("Game ended after " + Ticks + " ticks.   " + Winner.Name + " won and is now at " + SimulationModel.SubjectMatchWins[Winner] + "-" + SimulationModel.SubjectMatchLosses[Winner] + ".");
        }
