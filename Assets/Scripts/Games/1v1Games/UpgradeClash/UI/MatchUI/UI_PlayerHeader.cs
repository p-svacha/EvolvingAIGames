...
namespace UpgradeClash
{
    public class UI_PlayerHeader : MonoBehaviour
    {
        ...
        public void Init(Player player)
        {
            ...
            if(player is AIPlayer p) PlayerNameText.text += "  (" +  Player.Match.SimulationModel.SubjectMatchWins[p.Subject] + "-" + Player.Match.SimulationModel.SubjectMatchLosses[p.Subject] + ")";
        }
