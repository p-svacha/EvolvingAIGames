    ...
    public static List<Sprite> CardSprites
    {
        get
        {
            if (cardSprites == null)
            {
                ...
                string path = "Assets/Resources/BlobCardGame/CardPictures/C" + numberWithLeadingZeros + ".png";
                ...
                while (sprite != null)
                {
                    ...
                    path = "Assets/Resources/BlobCardGame/CardPictures/C" + numberWithLeadingZeros + ".png";
