...
public class VA_DestabilizeMinions : VisualAction
{
    ...
    public VA_DestabilizeMinions(VisualEntity source, List<VisualEntity> targets, Color color, Texture destablizedTexture)
    {
        ...
        DestabilizedTexture = destablizedTexture;
    ...
    {
        foreach (VisualEntity target in Targets) target.GetComponent<Renderer>().material.mainTexture = DestabilizedTexture;
